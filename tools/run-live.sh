#!/bin/sh
# E3 live gate (TODO, scaffolded): Forge 1.16.5 (1.16.5-36.2.42) server run
...
# from bridge-1122 (same phases, new pins) before claiming E3 :
...
#   E3_DIR   work dir (default ${TMPDIR:-/tmp}/matou-e3-live)
#   JAVA8_HOME Java 8 home (default /usr/lib/jvm/java-8-openjdk)
#   FORGE_URL  installer URL (default Maven 1.16.5-36.2.42 installer)
...
echo "FAIL e3-live : live not wired yet (phase E3 todo) — port tools/run-live.sh from bridge-1122, fill FORGE_URL/pins, then re-run with LIVE=1"
exit 1
